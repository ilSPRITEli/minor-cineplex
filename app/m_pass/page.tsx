...
const SubscriptionOption = ({ icon: Icon, label, isSelected, onClick }: { icon: LucideIcon, label: string, isSelected: boolean, onClick: () => void }) => (
  <div
    onClick={onClick}
...
export default function Mpass() {
  const [planType, setSelected] = useState<string | null>(null);
  ...
  async function handleSubmit(e: any) {
    ...
    await regNpass({ userId: session?.user?.id, planType, price });
  };
